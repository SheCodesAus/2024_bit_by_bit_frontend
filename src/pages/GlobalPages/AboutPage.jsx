    ...
    <main className={`flex flex-col items-center justify-center min-h-screen ${isNavbarOpen ? "ml-60" : "ml-20"}`}>
      ...
      <section className="flex flex-col items-center pt-16">
        ...
        <div className="flex flex-col justify-center w-3/4 space-x-2">
          <h3 className="text-center border-y border-gray-300 px-4 py-1 font-bold text-2xl">WHO WE ARE</h3>
      ...
      <section className="items-center">
        ...
        <section id="program-details" className="w-full max-w-4xl mx-auto px-4 py-4">
          <h2 className="text-center border-y border-gray-300 px-4 py-1 font-bold text-2xl">PROGRAM DETAILS</h2>
        ...
        <section id="contact-section" className="flex flex-col justify-center px-4 py-4 border-double border-2 border-orange-300 mb-8">
